...
namespace sustAInableEducation_backend.Migrations
{
    ...
    [Migration("20250208130138_AddParticipantQuizRelation")]
    partial class AddParticipantQuizRelation
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("sustAInableEducation_backend.Models.Quiz", b =>
                {
                    ...
                    b.Property<Guid?>("SpaceParticipantSpaceId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<string>("SpaceParticipantUserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.HasIndex("SpaceParticipantSpaceId", "SpaceParticipantUserId");
            ...
            modelBuilder.Entity("sustAInableEducation_backend.Models.Setting", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("sustAInableEducation_backend.Models.Space", b =>
                {
                    ...
                    b.Property<bool>("IsImageGenerationEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("sustAInableEducation_backend.Models.Quiz", b =>
                {
                    b.HasOne("sustAInableEducation_backend.Models.SpaceParticipant", null)
                        .WithMany("Quizzes")
                        .HasForeignKey("SpaceParticipantSpaceId", "SpaceParticipantUserId");
                });
