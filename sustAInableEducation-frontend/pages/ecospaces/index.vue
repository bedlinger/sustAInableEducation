<template>
    <div class="w-full h-full">
        <div class="w-screen flex items-center h-full bg-slate-50">
            ...
            <div class="content flex-1 h-full overflow-scroll">
                                                ...
                                                <template #body="{ data }">
                                                    ...
                                                    <div class="flex items-center">
                                                        <div class="size-5 mr-1">
                                                            <Icon name="ic:baseline-star-rate" class="size-5 bg-yellow-500" v-tooltip.bottom="{ value: 'Host', showDelay: 50 }"
                                                                v-if="data.isHost" />
                                                        </div>
...
function ecoSpaceIsFinished(space: EcoSpace) {
